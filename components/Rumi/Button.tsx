...
export default function Button({
  ...
  return (
    <button
      className={`button flex-shrink-0 inline-flex justify-center items-center group font-medium rounded-md focus-visible:outline-none focus-visible:ring-1 border ${
        ghost
