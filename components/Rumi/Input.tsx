...
export default function Input({
  ...
  return (
    <input
      className={`input flex-shrink-0 rounded-md focus-visible:outline-none focus-visible:ring-1 border border-light-300 dark:border-dark-500/90 hover:border-light-500/70 hover:dark:border-dark-400 focus:border-primary-500 focus:dark:border-primary-400 scale-${
        scale || "md"
